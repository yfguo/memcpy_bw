...
extern void tuned_memcpy();
extern void tuned_memcpy_ntr();
extern void tuned_memcpy_ntw();
...
void tuned_memcpy()
{
    memcpy(c, a, STREAM_ARRAY_SIZE * sizeof(STREAM_TYPE));
}

void tuned_memcpy_ntr()
{
    size_t n = STREAM_ARRAY_SIZE * sizeof(STREAM_TYPE);
    void * d = c, s = a;

    while (n >= 256) {
        _mm_prefetch(s + (64 * 0), 0);
        _mm_prefetch(s + (64 * 1), 0);
        _mm_prefetch(s + (64 * 2), 0);
        _mm_prefetch(s + (64 * 3), 0);
        ...
        _mm256_storeu_si256((__m256i *) (d + (32 * 0)), ymm0);
        _mm256_storeu_si256((__m256i *) (d + (32 * 1)), ymm1);
        _mm256_storeu_si256((__m256i *) (d + (32 * 2)), ymm2);
        _mm256_storeu_si256((__m256i *) (d + (32 * 3)), ymm3);
        _mm256_storeu_si256((__m256i *) (d + (32 * 4)), ymm4);
        _mm256_storeu_si256((__m256i *) (d + (32 * 5)), ymm5);
        _mm256_storeu_si256((__m256i *) (d + (32 * 6)), ymm6);
        _mm256_storeu_si256((__m256i *) (d + (32 * 7)), ymm7);
        d += 256;
        s += 256;
        n -= 256;
    }
